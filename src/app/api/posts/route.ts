...
//     //
//     // ----------------------------------------------------
//     // 📤 PART 1 — Upload Image to Supabase S3 Storage
//     // ----------------------------------------------------
//     //
//     if (imageUrl) {
...
//         console.log("❌ Provided imageUrl is NOT base64:", imageUrl);
//       }
...
//       // --------------------------------------------------
//       // 🔥 IMPORTANT — BUILD PUBLIC URL FOR S3 BUCKET
//       // Your S3 endpoint:
//       // https://jacosaynkzmzbjydxgha.storage.supabase.co/storage/v1/s3
//       // --------------------------------------------------

//       finalImageUrl = `https://jacosaynkzmzbjydxgha.storage.supabase.co/storage/v1/object/public/post-images/public/${fileName}`;
...
//     //
//     // ----------------------------------------------------
//     // 📝 PART 2 — Insert Post Into Database
//     // ----------------------------------------------------
//     //
...
//     console.log("📤 Sending response:", fullPost);
...
//     // ✅ FIX: Use image_url instead of imageUrl to match frontend
...
//         console.log("❌ Provided image_url is NOT base64:", image_url);
//       }
...
//       const base64 = image_url.split(";base64,").pop();
//       if (!base64) {
//         console.log("❌ ERROR: No base64 data found");
//         return NextResponse.json(
//           { error: "Invalid base64 image" },
...
//     console.log("📦 image_url length:", body.image_url?.length || 0);
...
//     //
//     // ----------------------------------------------------
//     // 📤 PART 1 — Upload Image to Supabase Storage
//     // ----------------------------------------------------
//     //
//     if (image_url) {
//       console.log("🖼 Base64 image received, starting upload process...");

//       // Validate base64 format
//       if (!image_url.startsWith("data:")) {
//         console.log("❌ Provided image_url is NOT base64");
//         return NextResponse.json(
...
//       console.log("🌍 PUBLIC IMAGE URL (from getPublicUrl):", finalImageUrl);
...
//     console.log("✅ Post image_url in DB:", post.image_url);
...
//     console.log("📤 Sending response with image_url:", fullPost.image_url);
