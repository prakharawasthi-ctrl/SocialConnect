      ...
      <main>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our community to share moments, connect with friends, and discover what's happening in the world.
          </p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Post updates, photos, and thoughts with your network
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Like, comment, and interact with posts from your community
              </p>
            </div>
          </div>
        </section>
