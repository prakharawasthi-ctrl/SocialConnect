...
//   onUpdate?: (postId: string, content: string) => Promise<void>; // ✅ Add update callback
// }
...
//   onRefresh,
//   onDelete,
//   onUpdate // ✅ Add to destructured props
// }: PostsFeedProps) {
//   // Debug logging
//   React.useEffect(() => {
...
//     console.log('  - Has onUpdate handler:', !!onUpdate);
...
//     }
//   }, [posts, loading, onUpdate, onDelete]);
...
//           onFollow={onFollow}
//           onDelete={onDelete}
//           onUpdate={onUpdate} // ✅ Pass update handler to PostCard
//         />
//       ))}
//     </div>
//   );
...
export default function PostsFeed({ 
  ...
  }, [posts, loading, currentUserRole, onUpdate, onDelete]);
    ...
    <div className="space-y-6">
      {posts.map(post => (
        <PostCard
          ...
          post={post}
          currentUserId={currentUserId}
          currentUserRole={currentUserRole} // ✅ Pass role to PostCard
          onLike={onLike}
          onFollow={onFollow}
          onDelete={onDelete}
          onUpdate={onUpdate}
