...
// import { CurrentUser } from '@/types';
// import EditProfileModal from './EditProfileModal';
// import { Settings, Calendar, Grid, Shield, User, Trash2 } from 'lucide-react';

// interface ProfileSidebarProps {
//   currentUser: CurrentUser;
//   profileUser?: CurrentUser; // The user whose profile is being viewed
...
//   // Can delete if: admin viewing someone else's profile
//   const canDelete = isAdmin && !isOwnProfile && profileUser;

//   // Update displayUser when props change
//   useEffect(() => {
...
//       // Call callback to handle navigation/UI update
//       if (onUserDeleted) {
//         onUserDeleted();
//       }
